...
const SvgBb = ({
  ...
  >
    ...
    />
    <path
      d="M13.565 2.382C5.537 6.264 0 14.485 0 24c0 9.515 5.537 17.736 13.565 21.618V2.382ZM34.435 2.382v43.236C42.463 41.736 48 33.515 48 24c0-9.515-5.537-17.736-13.565-21.618Z"
      fill="#0052B4"
    />
    <path
