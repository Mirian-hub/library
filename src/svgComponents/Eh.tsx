...
const SvgEh = ({
  ...
  >
    ...
    <g clipPath="url(#EH_svg__a)">
      ...
      />
      <path
        d="M7.029 7.03c-9.373 9.372-9.373 24.568 0 33.94L23.999 24 7.03 7.03ZM30.261 24a7.305 7.305 0 0 1 5.74-7.134 7.304 7.304 0 1 0 0 14.269A7.306 7.306 0 0 1 30.26 24Z"
        fill="#D80027"
      />
      <path
        d="m36.307 19.304 1.036 3.19h3.353l-2.713 1.97 1.036 3.188-2.712-1.97-2.712 1.97 1.036-3.188-2.713-1.97h3.353l1.036-3.19Z"
        fill="#D80027"
      />
    </g>
    <defs>
