...
const SvgBt = ({
  ...
  >
    ...
    <g clipPath="url(#BT_svg__a)">
      ...
      />
      <path
        d="m32.886 16.255-1.696 6.053-5.09-.94-3.276-6.753-8.85 3.14-.698-1.966-2.316-.285 1.745 4.917 6.09-1.558 1.731 4.878-4.21 6.213 7.145 6.095-1.354 1.588.91 2.148 3.387-3.97-4.395-4.496 3.36-3.938 7.486.54 1.705-9.235 2.052.378 1.405-1.862-5.13-.948Zm-8.888 7.908Z"
        fill="#FFEACF"
      />
    </g>
    <defs>
      <clipPath id="BT_svg__a">
