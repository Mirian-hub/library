...
const SvgCr = ({
  ...
  >
    ...
    />
    <path
      d="M24 0C16.725 0 10.208 3.237 5.806 8.348h36.387C37.792 3.237 31.273 0 24 0ZM42.193 39.652H5.806C10.208 44.763 16.726 48 24 48c7.274 0 13.791-3.237 18.193-8.348Z"
      fill="#0052B4"
    />
  </svg>
);
