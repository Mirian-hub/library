...
const SvgSs = ({
  ...
  >
    ...
    <g clipPath="url(#SS_svg__a)">
      ...
      />
      <path
        d="M13.11 33.218 7.03 40.97A23.922 23.922 0 0 0 24 48c9.99 0 18.552-6.103 22.165-14.782H13.11Z"
        fill="#496E2D"
      />
      <path
      ...
      />
      <path
        d="m7.818 18.033 2.93 4.087 4.793-1.522-2.983 4.049 2.93 4.088-4.773-1.585-2.982 4.049.032-5.03-4.772-1.584 4.793-1.523.032-5.029Z"
        fill="#FFDA44"
      />
    </g>
    <defs>
