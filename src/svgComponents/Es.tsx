...
const SvgEs = ({
  ...
  >
    ...
    />
    <path
      d="M46.507 15.652C43.114 6.513 34.318 0 23.999 0 13.68 0 4.883 6.513 1.492 15.652h45.015ZM1.492 32.348C4.883 41.487 13.68 48 23.999 48c10.32 0 19.116-6.513 22.508-15.652H1.492Z"
      fill="#D80027"
    />
  </svg>
);
